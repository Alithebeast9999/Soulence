    ...
    <div className="w-full max-w-sm">
      {!category && (
        <div className="grid gap-4">
          <button onClick={() => setCategory('calm')} className="p-3 rounded-xl bg-gray-700">🌙 Спокойствие</button>
          <button onClick={() => setCategory('focus')} className="p-3 rounded-xl bg-gray-700">☕ Фокус</button>
          <button onClick={() => setCategory('nature')} className="p-3 rounded-xl bg-gray-700">🌊 Природа</button>
          <button onClick={() => setCategory('cozy')} className="p-3 rounded-xl bg-gray-700">🔥 Уют</button>
